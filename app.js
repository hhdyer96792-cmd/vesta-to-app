...
function initColumnResizing() {
    ...
    tables.forEach(tableId => {
        ...
        headers.forEach((th, idx) => {
            // Добавляем ручку, если её ещё нет
            ...
            if (savedWidth) {
                ...
                // Если нет сохранённой, устанавливаем auto, но запоминаем текущую
                const current = th.offsetWidth;
                if (current) saveColumnWidth(tableId, idx, current);
            }
        });
    });
}
...
function startResize(e, th, colIndex, tableId) {
    ...
    resizeData = { th, colIndex, tableId, startX, startWidth };
...
function onResize(e) {
    ...
    // Устанавливаем такую же ширину для всех ячеек этого столбца
